      ...
      <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[0.82fr_1.18fr]">
        <div>
          <SectionHeader
            ...
            tone="dark"
          />
          <figure className="mt-10 border-l-2 border-orange-300 pl-5">
        ...
        <div className="grid gap-4">
          {reasons.map((reason, index) => (
            <article
              key={reason.title}
              className="motion-card grid gap-5 rounded-lg border border-white/10 bg-white/[0.06] p-6 transition hover:-translate-y-1 hover:border-orange-300/50 hover:bg-white/[0.09] sm:grid-cols-[4rem_1fr]"
            >
              <div className="grid h-14 w-14 place-items-center rounded-lg bg-orange-300 text-lg font-black text-zinc-950">
